...
from .io import create_html_figures, create_html_tables
...
status_ui = {'not started yet': 'The workflow has not been started yet. Waiting for other clients...',
			 ...
			 'sending config': 'Reading Interaction Network file and sending configuration to clients...',
			 'gathering config': 'Gathering configuration and Interaction Network from the coordinator...',
